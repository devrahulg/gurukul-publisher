...
# Drive access is not requested here. The publisher reads the private Drive folder
# through a separate service account (GOOGLE_SA_KEY, see SETUP.md step 3b). That
# keeps this app on YouTube's "sensitive" scopes only; Drive read access is a
# "restricted" scope, which Google verifies only after a paid security assessment.
